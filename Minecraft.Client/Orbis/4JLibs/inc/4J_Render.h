...
const int C4J_SRC_ALPHA = Gnm::kBlendMultiplierSrcAlpha;
const int C4J_ONE_MINUS_SRC_ALPHA = Gnm::kBlendMultiplierOneMinusSrcAlpha;
const int C4J_ONE = Gnm::kBlendMultiplierOne;
const int C4J_ZERO = Gnm::kBlendMultiplierZero;
const int C4J_DST_ALPHA = Gnm::kBlendMultiplierDestAlpha;
const int C4J_SRC_COLOR = Gnm::kBlendMultiplierSrcColor;
const int C4J_DST_COLOR = Gnm::kBlendMultiplierDestColor;
const int C4J_ONE_MINUS_DST_COLOR = Gnm::kBlendMultiplierOneMinusDestColor;
const int C4J_ONE_MINUS_SRC_COLOR = Gnm::kBlendMultiplierOneMinusSrcColor;
const int C4J_CONSTANT_ALPHA = Gnm::kBlendMultiplierConstantAlpha;
const int C4J_ONE_MINUS_CONSTANT_ALPHA = Gnm::kBlendMultiplierOneMinusConstantAlpha;

const int C4J_GREATER = Gnm::kCompareFuncGreater;
const int C4J_EQUAL = Gnm::kCompareFuncEqual;
const int C4J_LEQUAL = Gnm::kCompareFuncLessEqual;
const int C4J_GEQUAL = Gnm::kCompareFuncGreaterEqual;
const int C4J_ALWAYS = Gnm::kCompareFuncAlways;
