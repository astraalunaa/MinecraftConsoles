...
const int C4J_DEPTH_BUFFER_BIT = D3DCLEAR_ZBUFFER;
const int C4J_COLOR_BUFFER_BIT = D3DCLEAR_TARGET;

const int GL_QUADS = D3DPT_QUADLIST;
const int C4J_TRIANGLES = D3DPT_TRIANGLELIST;
const int C4J_LINE_STRIP = D3DPT_LINESTRIP;
const int C4J_TRIANGLE_STRIP = D3DPT_TRIANGLESTRIP;
const int C4J_TRIANGLE_FAN = D3DPT_TRIANGLEFAN;
const int C4J_LINES=D3DPT_LINELIST;
const int C4J_SRC_ALPHA = D3DBLEND_SRCALPHA;
const int C4J_ONE_MINUS_SRC_ALPHA = D3DBLEND_INVSRCALPHA;
const int C4J_ONE = D3DBLEND_ONE;
const int C4J_ZERO = D3DBLEND_ZERO;
const int C4J_DST_ALPHA = D3DBLEND_DESTALPHA;
const int C4J_SRC_COLOR = D3DBLEND_SRCCOLOR;
const int C4J_DST_COLOR = D3DBLEND_DESTCOLOR;
const int C4J_ONE_MINUS_DST_COLOR = D3DBLEND_INVDESTCOLOR;
const int C4J_ONE_MINUS_SRC_COLOR = D3DBLEND_INVSRCCOLOR;
const int C4J_CONSTANT_ALPHA = D3DBLEND_CONSTANTALPHA;
const int C4J_ONE_MINUS_CONSTANT_ALPHA = D3DBLEND_INVCONSTANTALPHA;

const int C4J_GREATER = D3DCMP_GREATER;
const int C4J_EQUAL = D3DCMP_EQUAL;
const int C4J_LEQUAL = D3DCMP_LESSEQUAL;
const int C4J_GEQUAL = D3DCMP_GREATEREQUAL;
const int C4J_ALWAYS = D3DCMP_ALWAYS;
